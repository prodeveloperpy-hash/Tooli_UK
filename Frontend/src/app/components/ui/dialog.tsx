    ...
    <DialogPortal>
      ...
      <div className="!fixed !inset-0 !z-[10001] flex items-center justify-center p-2 sm:p-4 pointer-events-none overflow-hidden h-[100dvh] w-screen">
        <DialogPrimitive.Content
          ref={internalRef}
          className={cn(
            "!bg-white !relative pointer-events-auto flex flex-col w-full max-w-[calc(100vw-1rem)] sm:max-w-[550px] !max-h-[96dvh] sm:!max-h-[90dvh] rounded-2xl shadow-2xl duration-200 outline-hidden overflow-y-auto !transform-none !top-auto !left-auto !m-0",
