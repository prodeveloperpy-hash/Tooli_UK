  ...
  return (
    <div className="w-full bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#030213] mb-5 md:mb-6 leading-tight">
              Get More Bookings, Not Enquiries.
            </h1>
            ...
            <p className="text-sm text-gray-400 font-bold mb-8 md:mb-10 italic">Free for early partners before launch</p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#030213]">Why List on Tooli?</h2>
          </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            <div className="text-center flex flex-col items-center bg-[#F8F9FC] md:bg-transparent rounded-2xl p-6 md:p-0">
              ...
              <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">More Bookings</h3>
            ...
            <div className="text-center flex flex-col items-center bg-[#F8F9FC] md:bg-transparent rounded-2xl p-6 md:p-0">
              ...
              <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">Live Weekly Prices</h3>
              <p className="text-gray-500 font-medium leading-relaxed">
            ...
            <div className="text-center flex flex-col items-center bg-[#F8F9FC] md:bg-transparent rounded-2xl p-6 md:p-0">
              ...
              <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">Fill Your Machines</h3>
              <p className="text-gray-500 font-medium leading-relaxed">
            ...
            <div className="text-center flex flex-col items-center bg-[#F8F9FC] md:bg-transparent rounded-2xl p-6 md:p-0">
              ...
              <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">No Time Wasted</h3>
              <p className="text-gray-500 font-medium leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-[#F8F9FC]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#030213]">How It Works</h2>
          </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="bg-[#FFF7F2] rounded-2xl md:rounded-[40px] p-6 sm:p-10 md:p-20 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 text-center md:text-left">
            <div>
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#030213] mb-4">Start Getting More Bookings Today</h2>
              <p className="text-base sm:text-lg md:text-xl text-gray-500 font-medium">Join Tooli and get your equipment booked by contractors in your area.</p>
            </div>
