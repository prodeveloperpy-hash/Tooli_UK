          ...
          '@graph': [
            {
              ...
              description: 'Tooli.uk is a UK plant and tool hire comparison platform. Compare prices from local and national suppliers including HSS, Speedy, Brandon, Smiths and independent depots.',
              areaServed: 'GB',
              sameAs: [],
            },
            {
              ...
              url: 'https://www.tooli.uk/',
              name: 'Plant & Tool Hire Comparison | Find the Best Rates Across the UK | Tooli.uk',
              description: 'Compare tool and plant hire prices across the UK. Get competitive quotes from trusted local suppliers and find the best hire rates in minutes.',
              isPartOf: { '@id': 'https://www.tooli.uk/#organization' },
              inLanguage: 'en-GB',
