    ...
    <div className="w-full bg-white">
      ...
      <section className="relative min-h-[460px] md:h-[500px] flex items-center overflow-hidden bg-[#F8F9FC] md:bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#030213] mb-5">
              About Tooli
            </h1>
            <div className="space-y-4 text-base sm:text-lg text-gray-500 font-medium leading-relaxed">
              <p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#030213] mb-4 relative inline-block">
              Our Mission
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-12 h-1 bg-brand-primary rounded-full" />
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-500 font-medium mt-9 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-10 md:gap-12 max-w-6xl mx-auto">
            <div className="text-center flex flex-col items-center">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-orange-50 flex items-center justify-center mb-5 md:mb-6">
                <Clock className="w-8 h-8 md:w-10 md:h-10 text-brand-primary" />
              </div>
            ...
            <div className="text-center flex flex-col items-center px-0 md:px-8 md:border-x border-gray-100">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-orange-50 flex items-center justify-center mb-5 md:mb-6">
      ...
      <section className="py-16 md:py-24 bg-[#F8F9FC]">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-2xl md:rounded-[40px] p-6 sm:p-10 md:p-24 shadow-sm border border-gray-100 relative overflow-hidden">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="relative z-10">
                <h2 className="text-3xl md:text-4xl font-extrabold text-[#030213] mb-6 md:mb-8">Who We Are</h2>
                <div className="space-y-5 md:space-y-6 text-base md:text-lg text-gray-500 font-medium leading-relaxed">
                  <p>
              ...
              <div className="hidden sm:flex justify-center md:justify-end relative z-0">
                <div className="text-[160px] md:text-[280px] font-black text-brand-primary leading-none select-none opacity-20 md:opacity-100">
                  T
                </div>
              </div>
            </div>
