...
export const equipmentApi = {
  getEquipment: async (categoryId?: string, locationId?: string, availabilityFrom?: string, availabilityTo?: string, page: number = 1, pageSize: number = 10, organizationId?: string, isActive?: boolean, isApproved?: boolean, search?: string): Promise<EquipmentResponse> => {
